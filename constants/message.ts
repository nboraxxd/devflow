...
export const PASSWORD_MESSAGES = {
  LENGTH: 'Password must between 6 and 64 characters',
  IS_STRONG: 'Password must contain at least 1 lowercase, 1 uppercase, 1 number and 1 symbol',
}

export const PICTURE_MESSAGES = {
  IS_REQUIRED: 'Picture is required',
  INVALID: 'Picture url is invalid',
}

export const PORTFOLIO_WEBSITE_MESSAGES = {
  INVALID: 'Portfolio website url is invalid',
}
